...
{
	$to = 'francisco@cuartetosantafe.com';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>A medida::</b></td><td>' . htmlentities($_REQUEST["custom_U1215"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>A medida::</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>A medida::</b></td><td>' . htmlentities($_REQUEST["custom_U1243"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>A medida::</b></td><td>' . htmlentities($_REQUEST["custom_U1267"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From:  francisco@cuartetosantafe.com' . "\r\n" . 'Reply-To: ' . $formEmail .  "\r\n" .'X-Mailer: Adobe Muse 7.2.232 with PHP/' . phpversion() . "\r\n" . 'Content-type: text/html; charset=utf-8' . "\r\n";
	
	$sent = @mail($to, $subject, $message, $headers);
	
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"gracias.html"}}';
